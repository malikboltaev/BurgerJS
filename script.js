...
function logic() {
    ...
    let full = document.querySelector('.header__timer')
    let number = 0
    function level(){
    ...
    for(let i = 0; i < productInfo.length; i++){
        let src = viewImages[i].getAttribute('src')
